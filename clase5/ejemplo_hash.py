...
# Se crea una variable con el contenido del fichero para el hash
nombre = open('catalogo_cf.csv', 'r').read()

# Se convierte el formato a bytes usando 'encode' (convierte a UTF-8)
