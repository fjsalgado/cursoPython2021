...
3.- Escribir en un nuevo fichero las primeras 5 líneas del fichero .tsv 
4.- Exportar la segunda y la tercera columna del fichero en formato .xlsx a un nuevo fichero
'''
import os
import pandas as pd 
import shutil
...
leer_fichero.to_excel(r"./data.xlsx", columns=["2nd chord", "3rd chord"], index=None, header=True)
